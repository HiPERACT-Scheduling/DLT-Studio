...
| `auto-ml` | meta | learned — gradient-boosted tree trained on labelled benchmarks selects the solver |
...
Maciej Drozdowski (Institute of Computing Science, Poznan University of Technology)
